...
const STACK_ORDER = ['te', 'ims', 'sms', 'lcs', 'sec', 'plmn', 'nas', 'rrc', 'sdap', 'pdcp', 'rlc', 'mac', 'phy', 'rf'];
// 옆 기둥 — 스택의 한 layer가 아니라 스택 전체를 가로지르거나 그 바깥에 있는 것들
const PILLAR_ORDER = ['uecap', 'ntn-tr', 't-com', 't-pct', 't-rrm', 't-rct'];
...
function renderOverview() {
  ...
  $('#view').innerHTML = `
    ...
    <div class="pillars">
      <h2>UE Capability · NTN Study · Test</h2>
