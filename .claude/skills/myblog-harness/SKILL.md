...
### 3.3 카테고리 (고정 순서, `js/home.js`의 `CATEGORIES`와 반드시 일치, 2026-07-30 갱신)

```
위성통신, 머신러닝과_인공지능, 반도체와_AI산업, OS, 해석역학과_장이론,
...
### 3.7 프라이버시 경계 (2026-07-30 신설, 반드시 지킬 것)

이 저장소는 GitHub public repo다. **`doc/유진` 폴더(아들의 대입 전략 자료 —
실명·학교·성적 등 민감 개인정보)의 내용은 어떤 경우에도 이 블로그의 소재로
